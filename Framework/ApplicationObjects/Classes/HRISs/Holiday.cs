...
namespace JCSoftwares_V.ApplicationObjects.Classes.HRISs
{
    class Holiday
    {
        ...
        public DataTable getAllData(string pDisplayType, string pPrimaryKey, string pSearchString)
        {
            ...
            HttpResponseMessage response = client.GetAsync("api/main/getHolidays?pDisplayType=" + pDisplayType + "&pPrimaryKey=" + pPrimaryKey + "&pSearchString=" + pSearchString + "").Result;
            ...
            try
            {
                switch (pOperation)
                {
                    case GlobalVariables.Operation.Add:
                        ...
                        HttpResponseMessage responseAdd = clientAdd.PostAsJsonAsync("api/main/insertHoliday/", this).Result;
                    ...
                    case GlobalVariables.Operation.Edit:
                        ...
                        HttpResponseMessage responseEdit = clientEdit.PostAsJsonAsync("api/main/updateHoliday/", this).Result;
        ...
        public bool remove(string pId)
        {
            ...
            try
            {
                HttpClient client = new HttpClient();
                client.BaseAddress = new Uri(GlobalVariables.BaseAddress);
                HttpResponseMessage response = client.GetAsync("api/main/removeHoliday?pId=" + pId + "&pUserId=" + GlobalVariables.UserId).Result;
