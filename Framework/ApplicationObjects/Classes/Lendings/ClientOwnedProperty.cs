...
{
    class ClientOwnedProperty
    {
        #region "CONSTRUCTORS"
        public ClientOwnedProperty()
        {
        ...
        public DataTable getAllData(string pClientId, string pPrimaryKey)
        {
            ...
            HttpResponseMessage response = client.GetAsync("api/main/getClientOwnedPropertys?pClientId=" + pClientId + "&pPrimaryKey=" + pPrimaryKey + "").Result;
            ...
            try
            {
                switch (pOperation)
                {
                    case GlobalVariables.Operation.Add:
                        ...
                        HttpResponseMessage responseAdd = clientAdd.PostAsJsonAsync("api/main/insertClientOwnedProperty/", this).Result;
                    ...
                    case GlobalVariables.Operation.Edit:
                        ...
                        HttpResponseMessage responseEdit = clientEdit.PostAsJsonAsync("api/main/updateClientOwnedProperty/", this).Result;
        ...
        public bool remove(string pId)
        {
            ...
            try
            {
                HttpClient client = new HttpClient();
                client.BaseAddress = new Uri(GlobalVariables.BaseAddress);
                HttpResponseMessage response = client.GetAsync("api/main/removeClientOwnedProperty?pId=" + pId + "&pUserId=" + GlobalVariables.UserId).Result;
