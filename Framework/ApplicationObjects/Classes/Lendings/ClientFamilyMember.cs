...
namespace JCSoftwares_V.ApplicationObjects.Classes.Lendings
{
    class ClientFamilyMember
    {
        ...
        public DataTable getAllData(string pClientId, string pPrimaryKey)
        {
            ...
            HttpResponseMessage response = client.GetAsync("api/main/getClientFamilyMembers?pClientId=" + pClientId + "&pPrimaryKey=" + pPrimaryKey + "").Result;
            ...
            try
            {
                switch (pOperation)
                {
                    case GlobalVariables.Operation.Add:
                        ...
                        HttpResponseMessage responseAdd = clientAdd.PostAsJsonAsync("api/main/insertClientFamilyMember/", this).Result;
                    ...
                    case GlobalVariables.Operation.Edit:
                        ...
                        HttpResponseMessage responseEdit = clientEdit.PostAsJsonAsync("api/main/updateClientFamilyMember/", this).Result;
        ...
        public bool remove(string pId)
        {
            ...
            try
            {
                HttpClient client = new HttpClient();
                client.BaseAddress = new Uri(GlobalVariables.BaseAddress);
                HttpResponseMessage response = client.GetAsync("api/main/removeClientFamilyMember?pId=" + pId + "&pUserId=" + GlobalVariables.UserId).Result;
